...
class CartPole():
    ...
    def __init__(self, buckets=(1, 1, 6, 12,), n_episodes=500, n_win_ticks=195, min_alpha=0.1, min_epsilon=0.1, gamma=1.0, ada_divisor=25, max_env_steps=None, monitor=False):
    ...
    def run(self):
        ...
        print(f"Average rewards per episode: {total_rewards / self.n_episodes}")
        print(f"Average timesteps per episode: {total_epochs / self.n_episodes}")
        print(f"Average penalties per episode: {total_penalties / self.n_episodes}")
